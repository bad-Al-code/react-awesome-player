...
import type { SettingsMenuProps, SettingsMenuType } from './types';
...
export function SettingsMenu({
  ...
  return (
    <div className="absolute right-3 bottom-14 z-20 w-52 overflow-hidden rounded-lg border border-gray-600 bg-black/80 text-sm text-white shadow-lg backdrop-blur-lg">
      {activeMenu === 'main' && (
      ...
      {activeMenu === 'quality' && (
        <div className="flex flex-col">
          <button
            onClick={() => setActiveMenu('main')}
            className="flex cursor-pointer items-center border-b border-gray-600 py-2 hover:bg-white/10"
          >
